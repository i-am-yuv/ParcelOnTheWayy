...
@Component({
  selector: 'app-edit-user-traveller',
  templateUrl: './edit-user-traveller.component.html',
  styleUrls: ['./edit-user-traveller.component.css']
})
export class EditUserTravellerComponent implements OnInit {
  ...
  updateUser()
  {
    ...
    this.http.put<any>(  `${this.apiUrl}/user/edit/`+sessionStorage.getItem('userID')  , this.userObj ).subscribe(
      res => 
      {
          ...
          this.toast.success({detail:"SUCCESS",summary:'Traveller Details Edited Successfully',duration:2000});
